...
### Реализация однотактного процессора RISC-V с использованием SpinalHDL (Scala).
...
*В составе АЛУ есть модуль полного 32-х битного сумматора, который в свою очередь реализован на базе полного 1-го битного сумматора.
